...
export const exampleResponse = {
  ...
  queues: null,
  conversationId:
    "AQQkADAwATM0MDAAMi04Y2FkLTc0YWEALTAwAi0wMAoAEAAmz8Fn71sZRY41XjbVxkDk",
  replyToInteractionId: null,
  top: true,
  emailInteractionDetails: {
    id: 1003,
    graphId:
      "AQMkADAwATM0MDAAMi04Y2FkLTc0YWEALTAwAi0wMAoARgAAA_PvvbQYdXdJnPPtqc5wOZ8HABLo_1QpixVNoonigVW8x5cAAAIBDAAAABLo_1QpixVNoonigVW8x5cAAAAHapgSAAAA",
    bccRecipientsJson: "[]",
    bccRecipients: [],
    body: {
      contentType: "html",
      content:
        '<html><head>\r\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><style type="text/css" style="display:none">\r\n<!--\r\np\r\n\t{margin-top:0;\r\n\tmargin-bottom:0}\r\n-->\r\n</style></head><body dir="ltr"><div class="elementToProof" style="font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">Hello world testing again on forwarded</div><div id="appendonsend"></div><hr tabindex="-1" style="display:inline-block; width:98%"><div id="divRplyFwdMsg" dir="ltr"><font face="Calibri, sans-serif" color="#000000" style="font-size:11pt"><b>From:</b> Kirtish Patil &lt;kirtish.patil@csinfocomm.com&gt;<br><b>Sent:</b> 25 April 2025 17:42<br><b>To:</b> CsInfocomm Test &lt;test.acc.2@outlook.com&gt;<br><b>Subject:</b> Fw: card code</font> <div>&nbsp;</div></div><style type="text/css" style="display:none">\r\n<!--\r\np\r\n\t{margin-top:0;\r\n\tmargin-bottom:0}\r\n-->\r\n</style><div dir="ltr"><div class="x_elementToProof" style="font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">Hello WOrld testing forwarded message</div><div id="x_appendonsend"></div><hr tabindex="-1" style="display:inline-block; width:98%"><div id="x_divRplyFwdMsg" dir="ltr"><font face="Calibri, sans-serif" color="#000000" style="font-size:11pt"><b>From:</b> Kirtish Patil &lt;kirtish.patil@csinfocomm.com&gt;<br><b>Sent:</b> 13 April 2025 16:36<br><b>To:</b> Sahil Rajesh Pawar &lt;sahil.pawar@csinfocomm.com&gt;<br><b>Subject:</b> Re: card code</font> <div>&nbsp;</div></div><style type="text/css" style="display:none">\r\n<!--\r\np\r\n\t{margin-top:0;\r\n\tmargin-bottom:0}\r\n-->\r\n</style><div dir="ltr"><div class="x_x_elementToProof" style="font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">Test Reply 2</div><div id="x_x_appendonsend"></div><hr tabindex="-1" style="display:inline-block; width:98%"><div id="x_x_divRplyFwdMsg" dir="ltr"><font face="Calibri, sans-serif" color="#000000" style="font-size:11pt"><b>From:</b> Sahil Rajesh Pawar &lt;sahil.pawar@csinfocomm.com&gt;<br><b>Sent:</b> 28 August 2024 13:06<br><b>To:</b> Kirtish Patil &lt;kirtish.patil@csinfocomm.com&gt;<br><b>Subject:</b> card code</font> <div>&nbsp;</div></div><style type="text/css" style="display:none">\r\n<!--\r\np\r\n\t{margin-top:0;\r\n\tmargin-bottom:0}\r\n-->\r\n</style><div dir="ltr"><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp;&lt;div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &lt;div className=&quot;max-w-sm w-80 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;img</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; className=&quot;IMAGE rounded-lg pt-2 w-full&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; src=&quot;https://www.91-cdn.com/hub/wp-content/uploads/2022/07/Top-laptop-brands-in-India.jpg&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; alt=&quot;&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; /&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)"><br></div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;div className=&quot;TEXT px-3&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;p className=&quot;mb-1 font-normal text-justify&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Here are the biggest enterprise technology acquisitions of 2021 so</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; far, in reverse chronological order.</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;/p&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;hr className=&quot;LINE h-px mt-2 bg-gray-200 border-0 dark:bg-gray-700&quot;&gt;&lt;/hr&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;div className=&quot;COMP flex justify-center h-10&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;div className=&quot;flex items-center gap-2&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;img</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; className=&quot;h-4&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; src=&quot;https://res.cloudinary.com/dzsrm697c/image/upload/v1724827352/arrow-left_wsxyez.png&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &gt;&lt;/img&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;span className=&quot;text-[#00DC47]&quot;&gt;Send More like This&lt;/span&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;hr className=&quot;LINE h-px &nbsp;bg-gray-200 border-0 dark:bg-gray-700&quot;&gt;&lt;/hr&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;div className=&quot;COMP flex justify-center h-10&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;div className=&quot;flex items-center gap-2&quot;&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;img</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; className=&quot;h-4&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; src=&quot;https://res.cloudinary.com/dzsrm697c/image/upload/v1724828530/share_robz0n.png&quot;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &gt;&lt;/img&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;span className=&quot;text-[#00DC47]&quot;&gt;Buy now&lt;/span&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &nbsp; &lt;/div&gt;</div><div style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)">&nbsp; &nbsp; &lt;/div&gt;</div><div class="x_x_x_elementToProof" style="line-height:19px; white-space:pre; font-family:Aptos,Aptos_EmbeddedFont,Aptos_MSFontService,Calibri,Helvetica,sans-serif; font-size:12pt; color:rgb(0,0,0)"><br></div></div></div></div></body></html>',
    },
    bodyPreview:
      "Hello world testing again on forwarded\r\n________________________________\r\nFrom: Kirtish Patil <kirtish.patil@csinfocomm.com>\r\nSent: 25 April 2025 17:42\r\nTo: CsInfocomm Test <test.acc.2@outlook.com>\r\nSubject: Fw: card code\r\n\r\nHello WOrld testing forwarded ",
    categories: [],
    ccRecipientsJson: "[]",
    ccRecipients: [],
    changeKey: "CQAAABYAAAAS6PtUKYsVTaKJ4oFVvMeXAAAHaF/0",
    conversationId:
      "AQQkADAwATM0MDAAMi04Y2FkLTc0YWEALTAwAi0wMAoAEAAmz8Fn71sZRY41XjbVxkDk",
    conversationIndex: "AQHa+RyhJs/BZ+9bGUWONV421cZA5LOi1fDHgBLuYC+ABfNTIg==",
    createdDateTime: "2025-04-29T07:04:38",
    flag: {
      id: 1003,
    ...
    from: {
      emailAddress: {
        name: "Kirtish Patil",
        address: "kirtish.patil@csinfocomm.com",
      },
    },
    ...
    internetMessageId:
      "<PN2P287MB1518C96C58853C6C627EECA49F802@PN2P287MB1518.INDP287.PROD.OUTLOOK.COM>",
    isDeliveryReceiptRequested: null,
    isDraft: false,
    isRead: true,
    isReadReceiptRequested: false,
    lastModifiedDateTime: "2025-04-29T07:04:40",
    parentFolderId:
      "AQMkADAwATM0MDAAMi04Y2FkLTc0YWEALTAwAi0wMAoALgAAA_PvvbQYdXdJnPPtqc5wOZ8BABLo_1QpixVNoonigVW8x5cAAAIBDAAAAA==",
    receivedDateTime: "2025-04-29T07:04:39",
    replyToJson: "[]",
    replyTo: [],
    sender: {
      emailAddress: {
    ...
    sentDateTime: "2025-04-29T07:04:31",
    subject: "Re: card code",
    toRecipientsJson: "",
    toRecipients: [],
    uniqueBody: null,
    webLink:
      "https://outlook.live.com/owa/?ItemID=AQMkADAwATM0MDAAMi04Y2FkLTc0YWEALTAwAi0wMAoARgAAA%2BPvvbQYdXdJnPPtqc5wOZ8HABLo%2B1QpixVNoonigVW8x5cAAAIBDAAAABLo%2B1QpixVNoonigVW8x5cAAAAHapgSAAAA&exvsurl=1&viewmodel=ReadMessageItem",
    attachments: [],
  },
